...
{
	unsigned char t[4];
	t[0] = (aes_8bit_mul_mod_0x11B(x[3], y[0]) ^ aes_8bit_mul_mod_0x11B(x[0], y[1]) ^ aes_8bit_mul_mod_0x11B(x[1], y[2]) ^ aes_8bit_mul_mod_0x11B(x[2], y[3])) & 0xff;
	t[1] = (aes_8bit_mul_mod_0x11B(x[2], y[0]) ^ aes_8bit_mul_mod_0x11B(x[3], y[1]) ^ aes_8bit_mul_mod_0x11B(x[0], y[2]) ^ aes_8bit_mul_mod_0x11B(x[1], y[3])) & 0xff;
	t[2] = (aes_8bit_mul_mod_0x11B(x[1], y[0]) ^ aes_8bit_mul_mod_0x11B(x[2], y[1]) ^ aes_8bit_mul_mod_0x11B(x[3], y[2]) ^ aes_8bit_mul_mod_0x11B(x[0], y[3])) & 0xff;
	t[3] = (aes_8bit_mul_mod_0x11B(x[0], y[0]) ^ aes_8bit_mul_mod_0x11B(x[1], y[1]) ^ aes_8bit_mul_mod_0x11B(x[2], y[2]) ^ aes_8bit_mul_mod_0x11B(x[3], y[3])) & 0xff;
	memcpy(z, t, sizeof(char) * 4);
}
